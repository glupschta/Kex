...
namespace Kex.Common
 {
     ...
     /// </example>
     public class ShellContextMenu1 : NativeWindow
     {
         #region Constructor
         /// <summary>Default constructor</summary>
         public ShellContextMenu1()
         {
         ...
         {
             //if (m.Msg == (int)WM.MENUSELECT || m.Msg == (int)WM.CAPTURECHANGED)
             //{
             //    return;
             //}
             //var catches = new[] {(int)WM.MENUCHAR};
             //if (true || catches.Contains(m.Msg))
             //{
             //    using (var sw = File.AppendText(@"C:\menu.log"))
             //    {
             //        if (m.Msg != (int)WM.ENTERIDLE)
